...
CREATE TABLE IF NOT EXISTS `mydb`.`DM_PONTO_TURISTICO` (
  ...
  `PTT_NOME` VARCHAR(45) NOT NULL,
  `PTT_INFORMACOES` VARCHAR(45) NOT NULL,
  `DM_PTT_VALOR_ENTRADA` DECIMAL(9,2) NULL,
  `DM_USU_CPF` VARCHAR(25) NULL,
  `DM_PTT_ENTRADA` DECIMAL(9,2) NULL,
  `DM_PTT_CUSTOS` DECIMAL(9,2) NULL,
  PRIMARY KEY (`PTT_ID`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`DM_REGIAO` (
  ...
  UNIQUE INDEX `REG_NOME_UNIQUE` (`REG_NOME` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
CREATE TABLE IF NOT EXISTS DM_IMAGEM_ROTEIRO_TURISTICO (
    IRT_ID INT AUTO_INCREMENT NOT NULL,
    IRT_IMAGE LONGTEXT NOT NULL,
    DM_RTT_ID INT NOT NULL,
    
    CONSTRAINT PK_IRT_ID PRIMARY KEY (IRT_ID),
    CONSTRAINT FK_DM_IMAGEM_ROTEIRO_TURISTICO_DM_ROTEIRO_TURISTICO 
        FOREIGN KEY (DM_RTT_ID) REFERENCES DM_ROTEIRO_TURISTICO (RTT_ID)
);
...
-- -----------------------------------------------------
-- Table `mydb`.`DM_USU_TPT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`DM_USU_TPT` (
  `DM_USU_TPT_ID` INT NOT NULL AUTO_INCREMENT,
  `DM_TPT_ID` INT NOT NULL,
  `DM_USU_CPF` VARCHAR(25) NOT NULL,
  INDEX `fk_DM_TIPO_PONTO_TURISTICO_has_DM_USUARIO_DM_USUARIO1_idx` (`DM_USU_CPF` ASC) VISIBLE,
  INDEX `fk_DM_TIPO_PONTO_TURISTICO_has_DM_USUARIO_DM_TIPO_PONTO_TUR_idx` (`DM_TPT_ID` ASC) VISIBLE,
  PRIMARY KEY (`DM_USU_TPT_ID`),
  UNIQUE INDEX `DM_USU_TPT_ID_UNIQUE` (`DM_USU_TPT_ID` ASC) VISIBLE,
  CONSTRAINT `fk_DM_TIPO_PONTO_TURISTICO_has_DM_USUARIO_DM_TIPO_PONTO_TURIS1`
    FOREIGN KEY (`DM_TPT_ID`)
    REFERENCES `mydb`.`DM_TIPO_PONTO_TURISTICO` (`TPT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DM_TIPO_PONTO_TURISTICO_has_DM_USUARIO_DM_USUARIO1`
    FOREIGN KEY (`DM_USU_CPF`)
    REFERENCES `mydb`.`DM_USUARIO` (`USU_CPF`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`DM_USU_REG`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`DM_USU_REG` (
  `DM_USU_REG_ID` INT NOT NULL AUTO_INCREMENT,
  `DM_REG_ID` INT NOT NULL,
  `DM_USU_CPF` VARCHAR(25) NOT NULL,
  PRIMARY KEY (`DM_USU_REG_ID`),
  INDEX `fk_DM_REGIAO_has_DM_USUARIO_DM_USUARIO1_idx` (`DM_USU_CPF` ASC) VISIBLE,
  INDEX `fk_DM_REGIAO_has_DM_USUARIO_DM_REGIAO1_idx` (`DM_REG_ID` ASC) VISIBLE,
  UNIQUE INDEX `DM_USU_REG_ID_UNIQUE` (`DM_USU_REG_ID` ASC) VISIBLE,
  CONSTRAINT `fk_DM_REGIAO_has_DM_USUARIO_DM_REGIAO1`
    FOREIGN KEY (`DM_REG_ID`)
    REFERENCES `mydb`.`DM_REGIAO` (`REG_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DM_REGIAO_has_DM_USUARIO_DM_USUARIO1`
    FOREIGN KEY (`DM_USU_CPF`)
    REFERENCES `mydb`.`DM_USUARIO` (`USU_CPF`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
